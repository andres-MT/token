...
public class LibroController {
	...
	private String add(@RequestParam("idLibro")@Nullable Integer idLibro
			          ...
			          ,@RequestParam("descripcion")@Nullable String decripcion
		...
		if(idLibro== null) {
			Libro libro =new Libro(0,titulo,editorial,numPaginas,edicion,idioma,fechaPublicacion,decripcion,tipoPasta,ISBN,numEjemplares,portada,presentacion,precio);
